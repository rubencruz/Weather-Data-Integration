...
The 'weather_data_integration' project was generated by using the default-python template.

* `src/`: Python source code for this project.
  * `src/weather_data_integration/`: Shared Python code that can be used by jobs and pipelines.
...
2. To deploy a development copy of this project, type:
    ...
    `[dev yourname] weather_data_integration_etl` to your workspace.
